...
print_status "Package is now available at: https://packagist.org/packages/aslnbxrz/filament-simple-translation"

# Show usage
echo ""
print_status "To install the new version:"
echo "composer require aslnbxrz/filament-simple-translation:^$NEW_VERSION"
